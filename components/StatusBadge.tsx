...
const splitStatusConfig: Record<SplitStatus, { label: string; className: string }> = {
  ...
  decanting: { label: "Proses Decant", className: "bg-sky-500/15 text-sky-400 ring-sky-500/20" },
...
const orderStatusConfig: Record<OrderStatus, { label: string; className: string }> = {
  ...
  decanting: { label: "Proses Decant", className: "bg-indigo-500/15 text-indigo-400 ring-indigo-500/20" },
  shipped: { label: "Dikirim", className: "bg-violet-500/15 text-violet-400 ring-violet-500/20" },
